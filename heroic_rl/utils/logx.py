...
from tensorflow.python.saved_model import builder, signature_def_utils, tag_constants

from .mpi_tools import mpi_statistics_scalar, proc_id
...
class Logger:
    ...
    pylogger = logging.getLogger("Logger")
    ...
    def save_state_for_training(self, state_dict, itr=None):
        """
